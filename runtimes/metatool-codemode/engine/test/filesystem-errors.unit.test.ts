 ...
 * §6  Metatool service resilience — inspect/discover don't crash on missing dirs
 */
...
import * as Fs from "../src/plugins/metatool-services/fs-ops"
import { FileReadError } from "../src/plugins/metatool-services/errors"
...
// ── §6 Metatool service resilience ──────────────────────────────

describe("§6 Metatool service resilience", () => {
  const fs = getFs()
