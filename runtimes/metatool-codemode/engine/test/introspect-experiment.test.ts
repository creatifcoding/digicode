...
const overlay: MetatoolOverlay = metatoolPlugin(process.cwd(), NodeFileSystemLayer)

describe('Phase E: overlay introspection', () => {
  it('has identity (id, name)', () => {
    expect(overlay.id).toBe('metatool')
  ...
  it('facet inventory via presence checks', () => {
    ...
    // Metatool should have at least these populated
