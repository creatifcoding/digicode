 ...
 * @module odk/scaffold
 *
 * Scaffold engine — generates MetatoolOverlay-compliant objects
...
/**
 * Generate a MetatoolOverlay-compliant object from a template.
 *
 ...
 */
export function scaffold(opts: ScaffoldOptions): MetatoolOverlay {
...
export function testHarness(
  ...
  const lines = [
    ...
    `import { validate, conformance, inspect } from "@tmnl/metatool/plugins/odk"`,
    `// TODO: import your overlay`,
    `// import { overlay } from "./${overlayId}"`,
    ``,
    `// Scaffold stub for testing — replace with real overlay`,
    `import { scaffold } from "@tmnl/metatool/plugins/odk"`,
