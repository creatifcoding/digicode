 ...
 * @module odk/overlay
 *
 * ODK as a MetatoolOverlay — the meta-overlay.
 ...
 */
export function odk(getOverlays?: () => ReadonlyArray<MetatoolOverlay>): MetatoolOverlay {
  return {
    id: "odk",
    ...
    guide: {
      sections: [{
        ...
        content: [
          ...
          "  cm.odk.scaffold(name, opts?)   → MetatoolOverlay (in-memory skeleton)",
    ...
    lifecycle: {
      onLoad: async (_core: MetatoolCore) => {
