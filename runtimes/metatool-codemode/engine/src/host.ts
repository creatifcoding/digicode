 ...
 * @module host
 *
 * MetatoolHost — the contract between the SDK and any host environment.
...
/**
 * MetatoolHost — the DI contract for any hosting environment.
 */
export interface MetatoolHost {
 ...
 */
export function createTestHost(cwd: string = process.cwd()): MetatoolHost {
  return {
