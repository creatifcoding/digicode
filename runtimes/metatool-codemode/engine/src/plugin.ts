 ...
 * @module plugin
 *
 * MetatoolPlugin — the contract between @tmnl/metatool core and domain plugins.
 *
...
export interface MetatoolPlugin {
   ...
   */
  readonly setup?: (core: MetatoolCore) => void | Promise<void>
...
export function mergePlugins(
  plugins: ReadonlyArray<MetatoolPlugin>,
