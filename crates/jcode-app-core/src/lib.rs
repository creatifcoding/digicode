...
// Provider tool `json!` schemas such as `swarm` and `tasker` are intentionally
// explicit and large; the default macro recursion limit is too small for them.
#![recursion_limit = "512"]
...
pub mod metatool_observability;
pub mod mission;
